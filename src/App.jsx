  ...
  const handleClick = async () => {
    ...
    try {
      const response = await fetch("/api/career", {
        ...
        body: JSON.stringify({
          message: `You are CareerPilot AI, a friendly career guidance assistant.
    ...
    <main className="app">
      ...
      <section className="hero">
        ...
        <p className="subtitle">
          Tell CareerPilot AI about your interests, favourite subject, and skills
          — and discover career paths made for you.
        </p>
        ...
        {result && (
          <div className="result-card">
            ...
            <div className="result-tip">
              💡 Tip: Explore these career paths and start building the skills that
              interest you most.
            </div>
